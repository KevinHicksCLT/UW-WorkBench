...
const TEMPLATES: { kind: 'CHECKLIST' | 'TEST'; name: string; description: string; keys: KeyDef[] }[] = [
  {
    ...
    keys: [
      ...
      { key: 'Applying roles confirmed', valueKind: 'ROLE' },
      { key: 'Applying roles trained', valueKind: 'TEXT' },
      { key: 'In-scope systems/SOR where the control operates', valueKind: 'APPLICATION' },
      { key: 'Control procedure documented', valueKind: 'TEXT' },
      { key: 'Control procedure version approved', valueKind: 'TEXT' },
      ...
      { key: 'Remediation ticket linked for each exception', valueKind: 'TEXT' },
    ],
  },
  {
    kind: 'TEST',
    ...
    keys: [
      ...
      { key: 'Sampling method', valueKind: 'TEXT' },
      ...
      { key: 'Re-test path', valueKind: 'TEXT' },
    ],
  },
  {
    kind: 'CHECKLIST',
    ...
    keys: [
      ...
      { key: 'In-scope processes', valueKind: 'TEXT' },
      { key: 'In-scope systems', valueKind: 'APPLICATION' },
      { key: 'Compliance procedure documented', valueKind: 'TEXT' },
      { key: 'Compliance procedure approved', valueKind: 'TEXT' },
      { key: 'Filing/reporting deadlines tracked', valueKind: 'TEXT' },
      { key: 'Deadline reminders configured', valueKind: 'TEXT' },
      { key: 'Evidence retained per the retention requirement', valueKind: 'TEXT' },
      { key: 'Violations/exceptions logged with disposition', valueKind: 'TEXT' },
      { key: 'Remediation sign-off captured', valueKind: 'ROLE' },
    ],
  },
  {
    kind: 'TEST',
    ...
    keys: [
      ...
      { key: 'Evidence location for test results', valueKind: 'TEXT' },
      { key: 'Regulator-ready documentation', valueKind: 'TEXT' },
      { key: 'Regulator response path', valueKind: 'TEXT' },
    ],
  },
];
