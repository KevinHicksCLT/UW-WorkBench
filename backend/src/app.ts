...
import impactRoutes from './routes/impact/index.js';
...
import ratePriceRoutes from './routes/rate-price/index.js';
...
import formsRoutes from './routes/forms/index.js';
...
app.use('/product-spine', productSpineRoutes);
app.use('/portfolio', portfolioRoutes);
app.use('/uw', uwRoutes);
app.use('/rate-price', ratePriceRoutes);
