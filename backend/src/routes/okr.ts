...
router.get('/objectives/:id', async (req: Request, res: Response, next: NextFunction) => {
  try {
...
router.post('/objectives/:id/recompute', async (req: Request, res: Response, next: NextFunction) => {
  try {
...
router.post('/kpis', async (req: Request, res: Response, next: NextFunction) => {
  try {
...
router.patch('/kpis/:id', async (req: Request, res: Response, next: NextFunction) => {
  try {
...
router.delete('/kpis/:id', async (req: Request, res: Response, next: NextFunction) => {
  try {
