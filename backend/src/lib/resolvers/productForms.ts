...
// STATE_NAMES moved to productBoard.ts (the comparison needs it to group
// state elements per state) — re-exported here for existing importers.
export { STATE_NAMES } from './productBoard.js';
