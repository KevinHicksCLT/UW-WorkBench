...
export default function ProgramDetail() {
  ...
  const [showCreateInit, setShowCreateInit] = useState<any>(null); // workstream object
  ...
  return (
    <div>
      ...
      <div className="space-y-4">
        {program.workstreams.map((ws: any) => (
...
function CreateWorkstreamModal({ programId, onClose, onCreated }: { programId: string | undefined; onClose: () => void; onCreated: () => void }) {
...
function CreateInitiativeModal({ workstream, onClose, onCreated }: { workstream: any; onClose: () => void; onCreated: () => void }) {
...
function Modal({ children, title, onClose }: { children: ReactNode; title: ReactNode; onClose: () => void }) {
  return (
