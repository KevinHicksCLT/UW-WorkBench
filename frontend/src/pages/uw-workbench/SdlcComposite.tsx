  ...
  return (
    <div>
      <p className="text-[11px] text-[#737373] mb-3">
        The composite SDLC deliverable map — each value-chain step traced from its source
        deliverables (UW-WORK, RATE-PRICE, FORMS-RATION) through capabilities, requirements, and
        invariants to the artifacts that implement it in this app.
      </p>
