...
const UW_CORE_DOCS = [
  'UW-WORK-02 requirements workbook',
  'UW-WORK-03 HLD',
  'UW-WORK-04 LLD',
  'UW-WORK-11 validation & integration spec',
];
...
export const SDLC_STEPS: SdlcStep[] = [
  {
    ...
    derivedFrom: [...UW_CORE_DOCS, 'UW-WORK-06 wireframes', 'UW-WORK-09 ontology'],
  },
  {
    step: 2,
    ...
    derivedFrom: [...UW_CORE_DOCS, 'UW-WORK-10 ontology views'],
  },
  {
    step: 3,
    title: 'Enrichment',
    ...
    derivedFrom: [...UW_CORE_DOCS, 'UW-WORK-09 ontology'],
  },
  {
    step: 4,
    title: 'Appetite',
    ...
    derivedFrom: [...UW_CORE_DOCS, 'UW-WORK-06 wireframes'],
  },
  {
    step: 5,
    title: 'Triage',
  ...
  },
  {
    ...
    derivedFrom: [...UW_CORE_DOCS, 'UW-WORK-06 wireframes', 'UW-WORK-10 ontology views'],
  },
  {
    step: 7,
  ...
  },
  {
    ...
    derivedFrom: ['RATE-PRICE-00..10 deliverable set', 'UW-WORK-11 validation & integration spec'],
  },
  {
    step: 11,
    ...
    derivedFrom: [
      'FORMS-RATION HLD / LLD / requirements',
      'UW-WORK-11 validation & integration spec',
    ],
  },
  {
  ...
  },
  {
    ...
    derivedFrom: ['UW-WORK-02 requirements workbook', 'UW-WORK-03 HLD'],
    gap: true,
  },
  {
    step: 15,
