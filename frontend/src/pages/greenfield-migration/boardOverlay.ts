...
export const CHANGE_DOT: Record<StagedChange['type'], string> = { move: '#a3a3a3', connect: '#10b981', reconnect: '#4f46e5', disconnect: '#be123c' };
...
export function applyOverlay(base: { nodes: Node[]; edges: Edge[] }, ov: Overlay): { nodes: Node[]; edges: Edge[] } {
