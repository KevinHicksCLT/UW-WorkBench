...
type Signal = {
  id: string; kind: 'kpi' | 'system'; type: string; name: string; description: string | null;
    ...
    <div>
      <div className="mb-2">
        ...
        <p className="text-[11px] text-[#666666] mt-0.5">
          Every signal the model can measure — system-of-record telemetry (GitHub, Jira, ServiceNow) and operating-model KPIs.
          Click a row for its description &amp; provenance.
        </p>
      </div>
