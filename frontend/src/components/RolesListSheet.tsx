...
const cols: SheetCol<RoleRow>[] = [
  ...
  { key: 'roleType', label: 'Role Type', width: '100px', value: (r) => r.roleType ?? DASH },
  {
    ...
    values: (r) => r.valueStreams,
    render: (r) => listCell(r.valueStreams),
  },
  {
    key: 'deliverables',
    label: 'Deliverables',
    width: 'minmax(140px,1fr)',
    values: (r) => r.deliverables,
    render: (r) => listCell(r.deliverables),
  },
  {
    key: 'tasks',
    label: 'Tasks',
    width: 'minmax(140px,1fr)',
    values: (r) => r.tasks,
    render: (r) => listCell(r.tasks),
  },
  {
    key: 'standards',
    label: 'Standards',
    width: 'minmax(140px,1fr)',
    values: (r) => r.standards,
    render: (r) => listCell(r.standards),
  },
  {
    key: 'checklist',
    label: 'Checklist',
    width: 'minmax(150px,1.1fr)',
    values: (r) => r.checklist,
    render: (r) => listCell(r.checklist),
  },
];
