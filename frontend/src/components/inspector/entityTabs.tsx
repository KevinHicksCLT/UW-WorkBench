...
import {
  RACI,
  type AfterFn, type AppDetail, type AppRollup, type DelivDetail, type DelivRollup,
  type Payload, type PropTextFn, type Relation, type RoleDetail, type RoleRollup,
} from './types';

// ── Tasks (children / drill) ────────────────────────────────────────────────
export function TasksTab({ data, onRetarget }: { data: Payload; onRetarget: (id: string) => void }) {
...
// ── Roles ──────────────────────────────────────────────────────────────────
export function RolesTab({ data, edit, onNav, after, propText }: {
...
// ── Applications ──────────────────────────────────────────────────────────────
export function AppsTab({ data, edit, onNav, after, propText }: {
  data: Payload; edit: boolean; onNav: (p: string) => void;
  after: AfterFn;
  propText: PropTextFn;
}) {
...
export function DeliverablesTab({ data, edit, onNav, after }: {
  data: Payload; edit: boolean; onNav: (p: string) => void;
  after: AfterFn;
}) {
