...
export type RoleDetail = { nodeRoleId: string; roleId: string; name: string; relation: Relation; raci?: string | null };
...
export type TestingDetail = { id: string | null; deliverableId: string | null; system: string | null; location: string | null; checkType: string | null; expected: string | null };
export type TestingRollup = { id: string; system: string | null; location: string | null; checkType: string | null; expected: string | null };
...
export type TiedPlan = { id: string; name: string; source: string | null; checklist: PlanRow[]; testing: PlanRow[] };
export type TaskPlan = { checklist: PlanRow[]; testing: PlanRow[]; standards: TiedPlan[]; regulations: TiedPlan[]; defined: number; total: number };
...
export type Tab = 'Overview' | 'Work' | 'Tasks' | 'Roles' | 'Applications' | 'Deliverables' | 'Checklist' | 'Testing' | 'Governance';
export const TABS: Tab[] = ['Overview', 'Work', 'Tasks', 'Roles', 'Applications', 'Deliverables', 'Checklist', 'Testing', 'Governance'];
