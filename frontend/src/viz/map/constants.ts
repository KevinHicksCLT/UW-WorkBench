...
export type RenameState = { rawId: string; value: string; x: number; y: number; w: number; h: number; cat: string };
...
export const DRAGGABLE_TYPES = new Set(['coreNode', 'divisionNode', 'valueStreamNode', 'stepNode', 'subStepNode']);
