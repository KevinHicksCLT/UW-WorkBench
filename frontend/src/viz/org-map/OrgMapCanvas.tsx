...
import {
  orgNodeTypes, gridPositions, gridHeight, LOOSE, ROW_GAP_Y, CRUMB, CRUMB_SEP,
  type Division, type OrgData, type OrgDragState, type MoveRec, type RoleLite, type Segment,
  type OrgCompanyData, type OrgSegmentData, type OrgDivisionData, type OrgDeptData, type OrgRoleData,
} from './orgNodes';
