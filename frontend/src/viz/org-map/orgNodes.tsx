...
export type RoleLite = { id: string; name: string; roleLevel: string | null; roleFamily: string | null; valueStreamCount: number };
export type Dept = { id: string; name: string; roles: RoleLite[]; roleCount: number };
export type Division = { id: string; name: string; segment: string; departments: Dept[]; looseRoles: RoleLite[]; roleCount: number };
export type Segment = { id: string | null; name: string; divisions: Division[]; divisionCount: number; roleCount: number };
export type OrgData = { company: { id: string; name: string }; totals: Record<string, number>; segments: Segment[] };
...
export type OrgSegmentData = { name: string; divisionCount: number; focusState?: NodeFocusState; pieceIndex?: number } & EditAffordance;
export type OrgDivisionData = { name: string; segment: string; teamCount: number; roleCount: number; focusState?: NodeFocusState; pieceIndex?: number } & EditAffordance;
export type OrgDeptData = { name: string; segment: string; roleCount: number; focusState?: NodeFocusState; pieceIndex?: number } & EditAffordance;
export type OrgRoleData = { name: string; focusState?: NodeFocusState; pieceIndex?: number };
...
export function gridHeight(_n: number): number { return MAP_CARD_H; }
...
export type MoveRec = { parent: string; sameLevel: boolean; level: number; name: string; cat: string };
