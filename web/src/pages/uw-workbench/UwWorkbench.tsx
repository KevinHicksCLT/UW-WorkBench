// UW Workbench — AI-native underwriting decisioning module.
// Page shell: one tab bar (?tab= deep-linkable) over the workbench surfaces.
// The selected submission id lives here so pivoting from Pipeline to
// Workspace preserves selection; Governance rows can pivot the same way.
...
import PacksLibrary from './PacksLibrary';
...
export default function UwWorkbench() {
  ...
  // Selected submission survives tab pivots — it is page state, not URL state,
  // so flipping to Appetite and back keeps the desk where it was.
